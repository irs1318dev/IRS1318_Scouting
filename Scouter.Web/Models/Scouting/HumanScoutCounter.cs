...
namespace Scouter.Web.Models.Scouting
{
    public class HumanScoutCounter
    {
        ...
        public int ThrowShortOfOwnLandfill1 { get; set; }
        public int ThrowToStep1 { get; set; }
        ...
        public int ThrowShortOfOwnLandfill2 { get; set; }
        public int ThrowToStep2 { get; set; }
        ...
        public int ThrowShortOfOwnLandfill3 { get; set; }
        public int ThrowToStep3 { get; set; }
